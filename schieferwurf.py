...
class Ending(Scene):
    def construct(self):
        ...
        downloadlink = Tex("https://github.com/Namitera/Physik-SchieferWurf-13.01.2025")
        ...
        self.play(downloadlink.animate.set_opacity(1))
        self.play(downloadlink.animate.shift(0*LEFT + -3*UP))
